...
print('------------------------------------------'+max(100*h/a,128100*c/a,52*100*d/a,100*e/a,100*f,100*g/a)*'-')
print('See the financial breakdown below, based on a salary of $'+str(a))
print('------------------------------------------------------------------')
print('| mortgage/rent | $  '"{:9,.2f}".format(h),'|',"{:6.1%}".format(h/a),'|',int(100*h/a)*'#')
print('|         bills | $  '"{:9,.2f}".format(12*c),'|',"{:6.1%}".format(12*c/a),'|',int(12*100*c/a)*'#')
print('|          food | $  '"{:9,.2f}".format(52*d),'|',"{:6.1%}".format(52*d/a),'|',int(52*100*d/a)*'#')
print('|        travel | $  '"{:9,.2f}".format(e),'|',"{:6.1%}".format(e/a),'|',int(100*e/a)*'#')
print('|           tax | $  '"{:9,.2f}".format(f*a),'|',"{:6.1%}".format(f),'|',int(100*f)*'#')
print('|         extra | $  '"{:9,.2f}".format(g),'|',"{:6.1%}".format(g/a),'|',int(100*g/a)*'#')
print('------------------------------------------------------------------')
if g<=0:
