...
print('------------------------------------------------------------------')
print('| mortgage/rent | $  '"{:9,.2f}".format(h),'|',"{:5.1%}".format(h/a),'|',int(h/a)*'#')
print('|         bills | $  '"{:9,.2f}".format(12*c),'|',"{:5.1%}".format(12*c/a),'|',int(12*c/a)*'#')
print('|          food | $  '"{:9,.2f}".format(52*d),'|',"{:5.1%}".format(52*d/a),'|',int(52*d/a)*'#')
print('|        travel | $  '"{:9,.2f}".format(e),'|',"{:5.1%}".format(e/a),'|',int(e/a)*'#')
print('|           tax | $  '"{:9,.2f}".format(f*a),'|',"{:5.1%}".format(f),'|',int(f)*'#')
print('|         extra | $  '"{:9,.2f}".format(g),'|',"{:5.1%}".format(g/a),'|',int(g/a)*'#')
print('------------------------------------------------------------------')
if g<=0:
