...
print('------------------------------------------------------------------')
print('| mortgage/rent | $  '.format(h,'8,.2f),'|',"{:3.1%}".format(h/a),'|'+int(h/a)*'#')
print('|         bills | $  '.format(12*c,'8,.2f),'|',"{:3.1%}".format(12*c/a)+' | '+int(12*c/a)*'#')
print('|          food | $  '.format(52*d,'8,.2f),'|',"{:3.1%}".format(52*d/a)+' | '+int(52*d/a)*'#')
print('|        travel | $  '.format(e,'8,.2f),'|',"{:3.1%}".format(e/a)+' | '+int(e/a)*'#')
print('|           tax | $  '.format(f*a,'8,.2f),'|',"{:3.1%}".format(f)+' | '+int(f)*'#')
print('|         extra | $  '.format(g,'8,.2f),'|',"{:3.1%}".format(g/a)+' | '+int(g/a)*'#')
print('------------------------------------------------------------------')
if g<=0:
